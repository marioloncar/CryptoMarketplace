...
class CryptoMarketplaceApplication : Application() {
    ...
    private fun initConnectivityManager() {
        ...
        connectivityManager.registerDefaultNetworkCallback(object : ConnectivityManager.NetworkCallback() {
            override fun onAvailable(network: Network) = networkStatePublisher.publishHasNetworkConnection(true)
            override fun onLost(network: Network) = networkStatePublisher.publishHasNetworkConnection(false)
            override fun onUnavailable() = networkStatePublisher.publishHasNetworkConnection(false)
        })
    }
}
